...
class RoadRepresentationEvaluator(AbstractEvaluator):
    ...
    def evaluate(self):
        ...
        self._logger.info(
            "Start Kmeans, data.shape = {}, kinds = {}".format(
        ...
        result_path = (
            "./libcity/cache/{}/evaluate_cache/kmeans_category_{}_{}_{}_{}.json".format(
                self.exp_id, self.model, self.dataset, str(self.output_dim), str(kinds)
            )
        )
        ...
        result_path = (
            "./libcity/cache/{}/evaluate_cache/kmeans_qgis_{}_{}_{}_{}.csv".format(
                self.exp_id, self.model, self.dataset, str(self.output_dim), str(kinds)
            )
        )
