...
class HGCNDataset(TrafficStatePointDataset):
    ...
    def calculate_adj_mx_cluster(self):
        ...
        """
        self.adj_mx_cluster = np.zeros(
            (self.cluster_nodes, self.cluster_nodes), dtype=np.float32
        )
    ...
    def get_data_feature(self):
        ...
        return {
            ...
            "adj_mx_cluster": self.adj_mx_cluster,
            "centers_ind_groups": self.centers_ind_groups,
