...
def test_new_tlp_model():
    ...
    config = ConfigParser(
        task="traj_loc_pred",
        model=tested_trajectory_model,
        dataset=tested_trajectory_dataset,
        config_file=None,
...
def test_new_tsp_model():
    ...
    config = ConfigParser(
        ...
        model=tested_traffic_state_model,
...
def test_new_traj_encoder():
    ...
    config = ConfigParser(
        ...
        dataset=tested_trajectory_dataset,
        config_file=None,
        other_args={"batch_size": 2, "traj_encoder": tested_trajectory_encoder},
    )
    # load dataset
    dataset = get_dataset(config)
    # cut trajectory
