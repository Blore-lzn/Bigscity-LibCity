...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--params_file",
        type=str,
        default="hyper_example.txt",
        help="the file which specify the \
    ...
    parser.add_argument(
        ...
        type=str,
        default="grid_search",
        help="hyper-parameters search algorithm",
    )
    parser.add_argument(
        "--max_evals",
        type=int,
        default=100,
        help="Allow up to this many function \
    ...
    # logger
    logger = get_logger(
        {"model": args.model, "dataset": args.dataset, "exp_id": exp_id}
    )
    # seed
